...
public class Solution {
    public static void main(String[] args) {
        try {
            ...
            user1.setBirthDate(new Date(1989, 7, 25));
            user1.setMale(true);
            user1.setCountry(User.Country.UKRAINE);

            User user2 = new User();
            user2.setFirstName("Peter");
            user2.setBirthDate(new Date(1962, 6, 27));
            user2.setCountry(User.Country.OTHER);

            User user3 = new User();
            user3.setLastName("Lois");
            user3.setMale(false);
                ...
                for (User current : this.users) {
                    ...
                    if ("yes".equals(hasBirthDate))
                        sb.append(current.getBirthDate().getYear()).append(" ").
                                append(current.getBirthDate().getMonth()).
                                append(" ").append(current.getBirthDate().getDate()).append(" ");
                    else
                        sb.append("- - - ");
