                ...
                if (compareNames != 0) {
                    ...
                    if (compareDate != 0) {
                        ...
                        if (stock1.containsKey("change")) {
                            income1 = (Double) stock1.get("change");
                        } else
                            income1 = (Double) stock1.get("last") - (Double) stock1.get("open");

                        if (stock2.containsKey("change")) {
                            income2 = (Double) stock2.get("change");
                        } else
                            income2 = (Double) stock2.get("last") - (Double) stock2.get("open");

                        int compareIncome = income2.compareTo(income1);
                        if (compareIncome != 0)
