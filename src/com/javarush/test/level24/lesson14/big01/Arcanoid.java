...
public class Arcanoid
{
    ...
    public void draw(Canvas canvas)
    {
        ...
        //отрисуй кирпичи
        for (Brick oneBrick : bricks)
            oneBrick.draw(canvas);
        //отрисуй шарик
        Arcanoid.game.ball.draw(canvas);
        //отрисуй подставку
        Arcanoid.game.stand.draw(canvas);
    }
    ...
    {
        //двигай шарик
        Arcanoid.game.ball.move();
        //двигай подставку
        Arcanoid.game.stand.move();
    }
    ...
    public void checkEndGame()
    {
        ...
        if(ball.getY() >= Arcanoid.game.height)
            isGameOver = true;
    }
