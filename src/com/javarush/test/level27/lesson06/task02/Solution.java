...
public class Solution {
    ...
    public static boolean isNormalLockOrder(final Solution solution, final Object o1, final Object o2) throws Exception {
        //do something here
        boolean isSecondMonitorLockedBySomeMethod;
        synchronized (o1)
        {
            synchronized (o2)
            {
                ...
                // waiting for checkingThread to be blocked on monitors
                Thread.sleep(2 * DELAY);
            }
            // waiting for someMethodWithSynchronizedBlocks to lock second Object
            Thread.sleep(3 * DELAY);

            isSecondMonitorLockedBySomeMethod = checkSecondMonitorStatus(o2);
        }
        Thread.sleep(20 * DELAY); // wait for someMethod to finish
        return isSecondMonitorLockedBySomeMethod;
    }

    private static boolean checkSecondMonitorStatus(final Object second)
    {
        ...
        return  check.getState().equals(Thread.State.BLOCKED);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        String o1s = o1.toString().substring(o1.toString().lastIndexOf("@"));
        String o2s = o2.toString().substring(o2.toString().lastIndexOf("@"));
