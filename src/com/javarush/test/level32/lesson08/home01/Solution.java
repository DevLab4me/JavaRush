...
public class Solution {
    ...
    public static SomeInterfaceWithMethods getProxy() {
        ...
        SomeInterfaceWithMethods proxyObj = (SomeInterfaceWithMethods) Proxy.newProxyInstance(origin.getClass().getClassLoader(),
                origin.getClass().getInterfaces(), new CustomInvocationHandler(origin));
